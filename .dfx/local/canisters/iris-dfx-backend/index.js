...
import { idlFactory } from './iris-dfx-backend.did.js';
export { idlFactory } from './iris-dfx-backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_IRIS_DFX_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./iris-dfx-backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the iris-dfx-backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./iris-dfx-backend.did.js")._SERVICE>}
 */
export const iris_dfx_backend = createActor(canisterId);
