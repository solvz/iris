...
import { idlFactory } from './iris-dfx-frontend.did.js';
export { idlFactory } from './iris-dfx-frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_IRIS_DFX_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./iris-dfx-frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the iris-dfx-frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./iris-dfx-frontend.did.js")._SERVICE>}
 */
export const iris_dfx_frontend = createActor(canisterId);
